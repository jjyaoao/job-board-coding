...
- 我把秋招投递混乱这件事，丢给 Coding Agent 做了个工具
- 不是 Todo Demo：我让 AI 做了一个求职申请看板
- 用 Step 3.7 Flash 跑了一次真实前端需求，第一版能到哪
- 投递太多怕漏流程？我做了个本地求职看板
...
6. Honest conclusion: usable first version, still needs human review and polish.
...
- “从想法到第一版更快”
- “适合边界清晰的小工具”
- “工程师仍然负责 review、验收和继续优化”
- “不是只回答问题，而是在真实项目里读需求、改文件、跑构建”
